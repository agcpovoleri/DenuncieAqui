...
function(Marionette, App,
	...
	var ItemCategoriaView = Marionette.ItemView.extend({
		...
		events: {
			'click .linkNovaDenuncia': 'novaDenunciaByCategoria'
		},
		
		novaDenunciaByCategoria: function(e){
//			e.preventDefault();
//			var cid = $(e.target).attr('cid');
//			
//			var url = "categoria/new/"+cid;
//			App.Route.navigate('categoria/new/'+cid, { trigger: true });
		}
